...
const SEANCES = [
  ...
  { id: "C", label: "Abdos & Gainage", sub: "", color: "bg-orange-800" },
];
    ...
    <div className="min-h-screen bg-stone-100 text-stone-900 pb-16">
      ...
      <div className="max-w-3xl mx-auto px-5 mt-6">
        <div className="bg-emerald-800 text-white rounded-xl p-4 flex items-center justify-between flex-wrap gap-3">
          <div>
            <div className="text-xs font-bold text-emerald-100 uppercase tracking-wide">Séance du jour suggérée</div>
            <div className="text-xl font-bold text-white">Séance {activeSeance} — {activeSeanceInfo?.label}</div>
          </div>
          <div className="flex gap-2">
            {SEANCES.map((s) => (
              <button
                ...
                className={`font-mono text-base font-bold px-4 py-2 rounded-lg transition-colors ${
                  activeSeance === s.id ? "bg-white text-emerald-900" : "bg-emerald-900 text-white border border-emerald-400 hover:bg-emerald-700"
                }`}
              >
                {s.id}
              </button>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      {ex.type === "reps" ? (
                        <>
                          <input type="number" min="0" placeholder="kg"
                            ...
                            className="w-16 border border-stone-300 rounded-lg px-2 py-1.5 text-sm font-mono bg-white text-stone-900 placeholder-stone-400" />
                      ...
                      <button
                        ...
                        className="bg-emerald-700 text-white text-sm font-bold px-4 py-2 rounded-lg hover:bg-emerald-800 transition-colors shadow-sm"
                      >
